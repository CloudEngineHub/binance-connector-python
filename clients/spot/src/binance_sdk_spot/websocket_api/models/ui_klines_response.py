...
class UiKlinesResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in result (list of list)
        _items = []
        if self.result:
            for _item_result in self.result:
                if _item_result:
                    _items.append(
                        [
                            _inner_item.to_dict()
                            for _inner_item in _item_result
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UiKlinesResponse from a dict"""
        if obj is None:
            return None
